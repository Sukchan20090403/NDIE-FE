    ...
    <div className="max-w-4xl mx-auto py-10 px-6 text-base">
      ...
      <div className="space-y-8">
        <label className="flex items-start space-x-3">
          <input type="checkbox" checked={agreeAll} onChange={toggleAll}  className="w-4 h-4" />
        ...
        <label className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <span className="text-red-500 ml-1">(필수)</span>
            <div className="border p-4 mt-2 h-64 overflow-y-auto text-sm bg-gray-50 leading-relaxed">
              1. 개인정보 수집목적 및 이용목적(1) 홈페이지 회원 가입 및 관리회원 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별․인증, 회원자격 유지․관리, 제한적 본인확인제 시행에 따른 본인확인, 서비스 부정 이용 방지, 만 14세 미만 아동의 개인정보 처리시 법정대리인의 동의 여부 확인, 각종 고지․통지, 고충 처리 등의 목적(2) 재화 또는 서비스 제공(*예정)물품 배송, 서비스 제공, 계약서․청구서 발송, 콘텐츠 제공, 맞춤 서비스 제공, 본인인증, 연령인증, 요금 결제 및 정산, 채권추심 등의 목적(3) 고충 처리민원인의 신원 확인, 민원사항 확인, 사실조사를 위한 연락․통지, 처리 결과 통보 등2. 수집하는 개인정보 항목ID, 성명, 비밀번호, 주소, 휴대폰 번호, 이메일, 14세 미만 가입자의 경우 법정대리인 정보3. 개인정보 보유 및 이용기간회원탈퇴 시까지 (단, 관계 법령에 보존 근거가 있는 경우 해당 기간 시까지 보유, 개인정보처리방침에서 확인 가능)
            </div>
          </div>
        </label>
        ...
        <label className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            ...
            <div className="border p-4 mt-2 h-40 overflow-y-auto text-sm bg-gray-50 leading-relaxed">
              이벤트, 신상품 소식, 고객 혜택 등 다양한 정보 제공
            </div>
          </div>
        </label>
      </div>
